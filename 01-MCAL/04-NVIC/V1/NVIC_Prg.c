...
void MNVIC_EnableIRQ(IRQn_Type IRQn  ){
	if (  (IRQn >= WWDG && IRQn <= OTG_FS_WKUP ) || (IRQn >= TIM5 && IRQn <= OTG_FS)){
...
void WWDG_IRQHandler(void) {
    if (functionArray[WWDG] != NULL_PTR) {
    	functionArray[WWDG]();
    }
    else {
...
void TAMPER_IRQHandler(void) {
    if (functionArray[TAMPER] != NULL_PTR) {
    	functionArray[TAMPER]();
    } else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
}
...
void FLASH_IRQHandler(void) {
    if (functionArray[FLASH] != NULL_PTR) {
    	functionArray[FLASH]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void EXTI0_IRQHandler(void) {
    if (functionArray[EXTI0] != NULL_PTR) {
    	functionArray[EXTI0]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void EXTI1_IRQHandler(void) {
    if (functionArray[EXTI1] != NULL_PTR) {
    	functionArray[EXTI1]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void EXTI2_IRQHandler(void) {
    if (functionArray[EXTI2] != NULL_PTR) {
    	functionArray[EXTI2]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void EXTI3_IRQHandler(void) {
    if (functionArray[EXTI3] != NULL_PTR) {
    	functionArray[EXTI3]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void EXTI4_IRQHandler(void) {
    if (functionArray[EXTI4] != NULL_PTR) {
    	functionArray[EXTI4]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void DMA1_Channel1_IRQHandler(void) {
    if (functionArray[DMA1_Channel1] != NULL_PTR) {
    	functionArray[DMA1_Channel1]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void DMA1_Channel2_IRQHandler(void) {
    if (functionArray[DMA1_Channel2] != NULL_PTR) {
    	functionArray[DMA1_Channel2]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void DMA1_Channel3_IRQHandler(void) {
    if (functionArray[DMA1_Channel3] != NULL_PTR) {
    	functionArray[DMA1_Channel3]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void DMA1_Channel4_IRQHandler(void) {
    if (functionArray[DMA1_Channel4] != NULL_PTR) {
    	functionArray[DMA1_Channel4]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void DMA1_Channel5_IRQHandler(void) {
    if (functionArray[DMA1_Channel5] != NULL_PTR) {
    	functionArray[DMA1_Channel5]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void DMA1_Channel6_IRQHandler(void) {
    if (functionArray[DMA1_Channel6] != NULL_PTR) {
    	functionArray[DMA1_Channel6]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void DMA1_Channel7_IRQHandler(void) {
    if (functionArray[DMA1_Channel7] != NULL_PTR) {
    	functionArray[DMA1_Channel7]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void ADC1_2_IRQHandler(void) {
    if (functionArray[ADC1_2] != NULL_PTR) {
    	functionArray[ADC1_2]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void CAN1_TX_IRQHandler(void) {
    if (functionArray[CAN1_TX] != NULL_PTR) {
    	functionArray[CAN1_TX]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void CAN1_RX0_IRQHandler(void) {
    if (functionArray[CAN1_RX0] != NULL_PTR) {
    	functionArray[CAN1_RX0]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void CAN1_RX1_IRQHandler(void) {
    if (functionArray[CAN1_RX1] != NULL_PTR) {
    	functionArray[CAN1_RX1]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void CAN1_SCE_IRQHandler(void) {
    if (functionArray[CAN1_SCE] != NULL_PTR) {
    	functionArray[CAN1_SCE]();
    } else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
}
...
void EXTI9_5_IRQHandler(void) {
    if (functionArray[EXTI9_5] != NULL_PTR) {
    	functionArray[EXTI9_5]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void TIM1_BRK_IRQHandler(void) {
    if (functionArray[TIM1_BRK] != NULL_PTR) {
    	functionArray[TIM1_BRK]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void TIM1_UP_IRQHandler(void) {
    if (functionArray[TIM1_UP] != NULL_PTR) {
    	functionArray[TIM1_UP]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void TIM1_TRG_COM_IRQHandler(void) {
    if (functionArray[TIM1_TRG_COM] != NULL_PTR) {
    	functionArray[TIM1_TRG_COM]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void TIM1_CC_IRQHandler(void) {
    if (functionArray[TIM1_CC] != NULL_PTR) {
    	functionArray[TIM1_CC]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void TIM2_IRQHandler(void) {
    if (functionArray[TIM2] != NULL_PTR) {
    	functionArray[TIM2]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void TIM3_IRQHandler(void) {
    if (functionArray[TIM3] != NULL_PTR) {
    	functionArray[TIM3]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void TIM4_IRQHandler(void) {
    if (functionArray[TIM4] != NULL_PTR) {
    	functionArray[TIM4]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void I2C1_EV_IRQHandler(void) {
    if (functionArray[I2C1_EV] != NULL_PTR) {
    	functionArray[I2C1_EV]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void I2C1_ER_IRQHandler(void) {
    if (functionArray[I2C1_ER] != NULL_PTR) {
    	functionArray[I2C1_ER]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void I2C2_EV_IRQHandler(void) {
    if (functionArray[I2C2_EV] != NULL_PTR) {
    	functionArray[I2C2_EV]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void I2C2_ER_IRQHandler(void) {
    if (functionArray[I2C2_ER] != NULL_PTR) {
    	functionArray[I2C2_ER]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void SPI1_IRQHandler(void) {
    if (functionArray[SPI1] != NULL_PTR) {
    	functionArray[SPI1]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
...
void SPI2_IRQHandler(void) {
    if (functionArray[SPI2] != NULL_PTR) {
    	functionArray[SPI2]();
    } else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void USART1_IRQHandler(void) {
    if (functionArray[USART1] != NULL_PTR) {
    	functionArray[USART1]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void USART2_IRQHandler(void) {
    if (functionArray[USART2] != NULL_PTR) {
    	functionArray[USART2]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void USART3_IRQHandler(void) {
    if (functionArray[USART3] != NULL_PTR) {
    	functionArray[USART3]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void EXTI15_10_IRQHandler(void) {
    if (functionArray[EXTI15_10] != NULL_PTR) {
    	functionArray[EXTI15_10]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void RTCAlarm_IRQHandler(void) {
    if (functionArray[RTCAlarm] != NULL_PTR) {
    	functionArray[RTCAlarm]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
...
void OTG_FS_WKUP_IRQHandler(void) {
    if (functionArray[OTG_FS] != NULL_PTR) {
    	functionArray[OTG_FS]();
    }
    else {
    	Det_ReportError(MODULE_ID, MNVIC_ISR_ID, NVIC_E_PARAM_POINTER);
    }
